      ...
      <div className="flex-1 p-8 flex flex-col">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 space-y-4 md:space-y-0">
          ...
          <div className="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0 items-center w-full md:w-auto">
            ...
            <Link to="/AddProduct" className="bg-[#112D4E] text-white px-6 py-2 rounded-md hover:bg-[#0b213f] w-full md:w-auto text-center">
              Add Product
            </Link>
          </div>
        </div>
        ...
        {/* Footer Bar */}
        <div className="bg-[#112D4E] text-white p-4 rounded-md flex flex-col md:flex-row justify-around items-center text-lg font-semibold mt-8 space-y-4 md:space-y-0">
